 ...
 *
 * ⛔ ESQUELETO. A tela real entra no item PT-6 do plano do portal do cliente. Este arquivo
...
export default function Cronograma() {
  return (
    <Pagina titulo="Cronograma" subtitulo="O que o contrato prevê mês a mês foi feito?">
      <Vazio
        titulo="Em construção"
        descricao="Esta tela ainda não foi construída. Ela vai responder: o que o contrato prevê mês a mês foi feito?"
      />
    </Pagina>
  )
}
