 ...
 * Entrar — Quem sou eu??
 *
 * ⛔ ESQUELETO. A tela real entra no item PT-1 do plano do portal do cliente. Este arquivo
...
export default function Entrar() {
  return (
    <Pagina titulo="Entrar" subtitulo="Quem sou eu??">
      <Vazio
        titulo="Em construção"
        descricao="Esta tela ainda não foi construída. Ela vai responder: quem sou eu??"
      />
    </Pagina>
  )
}
